...
////            for(QVector<Process>::iterator it = p.begin(); it != p.end(); ++it) {
////                if(it->getId() == id) {
////                    QMessageBox::warning(this, tr("errorOperation, ID YA EXISTENTE"), tr("ID ingresado ya existen, por favor ingrese otra ID distinta"));
////                    ui->spnBx_ID->clear();
////                    break;
////                }
////            }
